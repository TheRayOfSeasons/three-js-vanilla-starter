...
const gridShaderSnippets = {
  ...
  main: `
    ...
    vScale = vec3(scaleX, scaleY, scaleZ) * uScaleMultiplier;
  ...
  fragmentShader: `
    ...
    float grid_tri_mapping(float size) {
      ...
      float line = min(min(grid.x, grid.y), grid.z) * 0.25;
    ...
    void main() {
        ...
        pc_FragColor = vec4(mix(diffuse, col, g1), 1.);
